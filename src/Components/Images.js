...
const ImagePane = () => {
    return ( 
        ...
        <img className="img-smaller img-8" src="breakfastburrito.jpg" alt="breakfast burrito" />
        <img className="img-smaller img-9" src="fullenglish.jpg" alt="full english breakfast" />
        <img className="img-smaller img-10" src="granola.jpg" alt="granola with fruit" />
