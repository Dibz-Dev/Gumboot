    ...
    return ( 
        ...
        <div className="review-wrapper">
             <div className="review-ind">
                ...
                <img className="reviewArrowLeft" style={{ transform: 'rotate(180deg)'}} onClick={arrowClickLeft} src="altArrow.svg" alt="" />
                    ...
                    <img className="reviewArrowRight" onClick={arrowClickRight} src="altArrow.svg" alt="" />
