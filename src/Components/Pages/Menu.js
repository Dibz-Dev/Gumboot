        ...
        <div id="Menu" >
                ...
                <p className="menu-spec">All you can eat Brunch<br /> EVERY Sunday!!</p>
                  <div className="svg-btn-wrapper">
                     <img className="svg-food" onClick={onFood} src="food-btn.svg" alt="food menu button" />
                     <img className="svg-drink" onClick={onDrinks} src="drinks-btn.svg" alt="drink menu button" />
                  </div>
